...
class Qwen2MoePhimoeModelsQwen2MoeTest < Minitest::Test
  def setup
    @mx = MLX::Core
  end
...
class Qwen2MoePhimoeModelsTest < Minitest::Test
  def setup
    @mx = MLX::Core
  end
...
class Qwen2MoePhimoeModelsModelsRegisteredAndResolveTest < Minitest::Test
